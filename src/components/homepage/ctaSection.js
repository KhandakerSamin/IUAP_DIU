        ...
        <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 p-10 sm:p-16 lg:p-20 text-center reveal">
            ...
            <p className="text-lg sm:text-xl text-slate-300 mb-10 max-w-2xl mx-auto font-light leading-relaxed reveal reveal-delay-1">
              Secure your place at the IAUP Semi-Annual Meeting 2026 hosted by Daffodil International University. Early bird registration ends <span className="font-semibold text-white">September 20, 2026</span>.
            </p>
