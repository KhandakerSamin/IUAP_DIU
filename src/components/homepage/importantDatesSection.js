...
export default function ImportantDatesSection() {
  const importantDates = [
    { label: "Early Bird Registration Deadline", date: "September 20, 2026" },
    { label: "General Registration Deadline", date: "October 10, 2026" },
    { label: "Late Registration Deadline", date: "October 30, 2026" },
