...
export const metadata = {
  ...
  description: "Placeholder page for IAUP Semi-Annual Meeting 2026 speakers.",
};
        ...
        <section className="mx-auto flex w-full max-w-4xl flex-col gap-6 px-4 sm:px-6 lg:px-8">
          <div className="rounded-3xl border border-slate-200 bg-white/90 p-8 shadow-sm sm:p-12">
            ...
            <p className="mt-4 max-w-2xl text-base leading-7 text-slate-600 sm:text-lg">
              Placeholder content for the Speakers page. Add speaker profiles, titles, and session details here.
            </p>
          </div>
        </section>
      </main>
